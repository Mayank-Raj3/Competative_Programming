...
void solve() {
// INDEA : make 1,2,3,4,5 first make pair with all then even number then with all odd remaing number you will get the pair
	int n ; cin >> n ;
	if (n % 2) {
		YES
		vector<pii> arr(n);
