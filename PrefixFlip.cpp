...
void solve() {
	...
	vi ans;
	int start = 0 , end = n - 1 , invert = 0 , rev = 1  ;
	// start and end will be used to reverse
	//  invert when odd = changed bit when even same
