...
/*
              ------------
   [---------------          ] [ --------]
____|______________________|_____|_________|_____

Q how many continous segmenet are there
above have 2 segment
...
void insert(int  l , int r) {
	//jo phle ha vo dund rha ha ye
	auto it = mt.lower_bound({l, (-MOD * MOD)}); // hame
	if (it != mt.begin()) {
		it--;
		/*
		// agr it ka second bada ha
		_____ X delete karke
		   ______
		_________  ye insert
